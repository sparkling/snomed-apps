...
exports.config = {
  ...
  server:                      # configuration for server when server option is enabled via CLI
    ...
    path: 'server.ls'      # valid when defaultServer.enabled: false, path to file for provided
    ...
    views:                     # configuration for the view layer of your application
      compileWith: 'ejs'      # Valid options: "jade", "hogan", "html", "ejs", "handlebars", "dust".
                                 # The compiler for your views.
      extension: 'ejs'        # extension of your server views
